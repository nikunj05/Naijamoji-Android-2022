...
import com.naijamojiapp.ime.compat.InputConnectionCompatUtils;
import com.naijamojiapp.ime.latin.common.Constants;
import com.naijamojiapp.ime.latin.common.StringUtils;
import com.naijamojiapp.ime.latin.common.UnicodeSurrogate;
import com.naijamojiapp.ime.latin.inputlogic.PrivateCommandPerformer;
import com.naijamojiapp.ime.latin.settings.SpacingAndPunctuations;
import com.naijamojiapp.ime.latin.utils.CapsModeUtils;
import com.naijamojiapp.ime.latin.utils.DebugLogUtils;
import com.naijamojiapp.ime.latin.utils.NgramContextUtils;
import com.naijamojiapp.ime.latin.utils.ScriptUtils;
import com.naijamojiapp.ime.latin.utils.SpannableStringUtils;
import com.naijamojiapp.ime.latin.utils.StatsUtils;
import com.naijamojiapp.ime.latin.utils.TextRange;
...
public final class RichInputConnection implements PrivateCommandPerformer {
    ...
    private static InputMethodService mParent = null;
    ...
    public static boolean doCommitContent(String description,File file,Bitmap sendImageUrl) {
        String inputType = "";
        final Uri contentUri = FileProvider.getUriForFile(mParent, AUTHORITY, file);
        Log.i("contentUri",contentUri.toString());
        final EditorInfo mInputEditorInfo =  mParent.getCurrentInputEditorInfo();

        if(mInputEditorInfo.packageName.equalsIgnoreCase("com.whatsapp")){
            inputType = "image/webp.wasticker";
        }else{
            inputType = "image/webp";
        }
        Log.i("mInputEditorInfo",mInputEditorInfo.toString());
        final int flag;
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            flag = 0;
            try {
                mParent.grantUriPermission(mInputEditorInfo.packageName, contentUri, Intent.FLAG_GRANT_READ_URI_PERMISSION);
            } catch (Exception e){}
        }

        if (Build.VERSION.SDK_INT >= 25) {
            if(mInputEditorInfo.contentMimeTypes !=null){
                final InputContentInfoCompat inputContentInfoCompat = new InputContentInfoCompat(
                        contentUri,new ClipDescription(description, new String[]{inputType}),
                        null);
                return  InputConnectionCompat.commitContent(mParent.getCurrentInputConnection(),mInputEditorInfo,inputContentInfoCompat,flag,null);
            }else{
                Utility.Companion.share(mParent,mInputEditorInfo.packageName,sendImageUrl);
            }
        }else{
            final InputContentInfoCompat inputContentInfoCompat = new InputContentInfoCompat(
                    contentUri,new ClipDescription(description, new String[]{inputType}),
      ...
      /*  if(mInputEditorInfo.inputType == 0 || flag == 0){
            Log.i("yes","is in"+ mInputEditorInfo.inputType);
            if (mInputEditorInfo.packageName.equals("com.whatsapp")) {
                Intent intent = new Intent("android.intent.action.SEND");
                intent.setType("image/*");
                intent.putExtra("android.intent.extra.STREAM", sendImageUrl);
//                intent.setFlags(276824064);
            ...
            } else if (mInputEditorInfo.packageName.equals(MessengerUtils.PACKAGE_NAME)) {
                ...
                intent2.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    ...
                    intent2.putExtra("android.intent.extra.STREAM", sendImageUrl);
                    mParent.startActivity(intent2);
                } catch (Exception e) { }
            } else if (mInputEditorInfo.packageName.equals("com.facebook.katana")) {
                ...
                intent3.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    ...
                    intent3.putExtra("android.intent.extra.STREAM", sendImageUrl);
                    mParent.startActivity(intent3);
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
            } else if (mInputEditorInfo.packageName.equals("com.google.android.talk")) {
                Intent intent4 = new Intent("android.intent.action.SEND");
                intent4.setType("image/png");
            intent4.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent4.setPackage("com.google.android.talk");
                intent4.putExtra("android.intent.extra.STREAM", sendImageUrl);
                mParent.startActivity(intent4);
            } else if (mInputEditorInfo.packageName.equals("com.tencent.mm")) {
                Intent intent5 = new Intent();
                intent5.setAction("android.intent.action.SEND");
            intent5.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent5.setType("image/png");
                intent5.setPackage("com.tencent.mm");
                intent5.putExtra("android.intent.extra.STREAM", sendImageUrl);
                mParent.startActivity(intent5);
            } else if (mInputEditorInfo.packageName.equals("com.viber.voip")) {
                Intent intent6 = new Intent();
                intent6.setAction("android.intent.action.SEND");
                intent6.setType("image/png");
            intent6.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent6.setPackage("com.viber.voip");
                intent6.putExtra("android.intent.extra.STREAM", sendImageUrl);
                mParent.startActivity(intent6);
            } else if (mInputEditorInfo.packageName.equals("jp.naver.line.android")) {
            ...
            intent7.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent7.putExtra("android.intent.extra.STREAM", sendImageUrl);
                mParent.startActivity(intent7);
            } else if (mInputEditorInfo.packageName.equals("com.bsb.hike")) {
            ...
            intent8.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                ...
                intent8.putExtra("android.intent.extra.STREAM", sendImageUrl);
                mParent.startActivity(intent8);
            } else if (mInputEditorInfo.packageName.equals("com.bbm")) {
            ...
            intent9.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                ...
                intent9.putExtra("android.intent.extra.STREAM", sendImageUrl);
                ...
                List queryIntentActivities = packageManager.queryIntentActivities(intent10, 0);
                for (int i = 0; i < queryIntentActivities.size(); i++) {
                    ActivityInfo activityInfo = ((ResolveInfo) queryIntentActivities.get(i)).activityInfo;
                    if (new ComponentName(activityInfo.applicationInfo.packageName, activityInfo.name).getPackageName().matches(mInputEditorInfo.packageName)) {
                        ...
                        intent11.setPackage(mInputEditorInfo.packageName);
                        intent11.putExtra("android.intent.extra.STREAM", sendImageUrl);
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.naijamojiapp.ime.latin.common.Constants.UnicodeSurrogate
