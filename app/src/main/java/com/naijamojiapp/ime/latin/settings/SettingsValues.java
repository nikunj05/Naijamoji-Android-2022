...
import com.naijamojiapp.ime.compat.AppWorkaroundsUtils;
...
import com.naijamojiapp.ime.latin.utils.TargetPackageInfoGetterTask;

/**
 * When you call the constructor of this class, you may want to change the current system locale by
 * using {@link com.naijamojiapp.ime.latin.utils.RunInLocale}.
 */
...
public class SettingsValues {
    ...
    public boolean isBrokenByRecorrection() {
        final AppWorkaroundsUtils appWorkaroundUtils = mAppWorkarounds.get(null, TIMEOUT_TO_GET_TARGET_PACKAGE);
