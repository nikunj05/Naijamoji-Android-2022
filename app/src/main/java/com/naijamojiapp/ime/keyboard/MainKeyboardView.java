...
import com.naijamojiapp.ime.accessibility.MainKeyboardAccessibilityDelegate;
import com.naijamojiapp.ime.annotations.ExternallyReferenced;
import com.naijamojiapp.ime.keyboard.internal.DrawingPreviewPlacerView;
import com.naijamojiapp.ime.keyboard.internal.DrawingProxy;
import com.naijamojiapp.ime.keyboard.internal.GestureFloatingTextDrawingPreview;
import com.naijamojiapp.ime.keyboard.internal.GestureTrailsDrawingPreview;
import com.naijamojiapp.ime.keyboard.internal.KeyDrawParams;
import com.naijamojiapp.ime.keyboard.internal.KeyPreviewChoreographer;
import com.naijamojiapp.ime.keyboard.internal.KeyPreviewDrawParams;
import com.naijamojiapp.ime.keyboard.internal.KeyPreviewView;
import com.naijamojiapp.ime.keyboard.internal.MoreKeySpec;
import com.naijamojiapp.ime.keyboard.internal.NonDistinctMultitouchHelper;
import com.naijamojiapp.ime.keyboard.internal.SlidingKeyInputDrawingPreview;
import com.naijamojiapp.ime.keyboard.internal.TimerHandler;
import com.naijamojiapp.ime.latin.RichInputMethodSubtype;
...
import com.naijamojiapp.ime.latin.settings.DebugSettings;
import com.naijamojiapp.ime.latin.utils.LanguageOnSpacebarUtils;
import com.naijamojiapp.ime.latin.utils.TypefaceUtils;
...
public final class MainKeyboardView extends KeyboardView implements DrawingProxy,
    ...
    Typeface font = ResourcesCompat.getFont(getContext(), R.font.quicksandmedium);
    ...
    public void setKeyboard(final Keyboard keyboard) {
        ...
        mKeyDetector.setKeyboard(keyboard, -getPaddingLeft(),   getVerticalCorrection()+  (-getPaddingTop()));
    ...
    public void showGestureFloatingPreviewText(@Nonnull final SuggestedWords suggestedWords,
        ...
        if (dismissDelayed) {
            mTimerHandler.postDismissGestureFloatingPreviewText(mGestureFloatingPreviewTextLingerTimeout);
        }
    }
