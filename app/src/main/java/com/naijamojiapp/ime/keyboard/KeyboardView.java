...
public class KeyboardView extends View {
    ...
    protected boolean mIsEmojiSearchMode;
...
//            "fonts/NunitoSansRegular.ttf");
    ...
    //Added New
    protected boolean isGifSearchMode;
    ...
    protected void onDrawKeyTopVisuals(@Nonnull final Key key, @Nonnull final Canvas canvas,
        ...
        if (hintLabel != null) {
            ...
            canvas.drawText(hintLabel, 0,
                    hintLabel.length(),
                    hintX,
                    hintBaseline + adjustmentY, paint);
        }
    ...
    protected void drawKeyPopupHint(@Nonnull final Key key, @Nonnull final Canvas canvas,
        ...
        paint.setTextAlign(Align.CENTER);
        final float hintX = keyWidth - mKeyHintLetterPadding - TypefaceUtils.getReferenceCharWidth(paint) / 2.0f;
    ...
    public void setGifSearchMode(boolean gifSearchMode) {
        this.isGifSearchMode = gifSearchMode;
        invalidateAllKeys();
    }
}
