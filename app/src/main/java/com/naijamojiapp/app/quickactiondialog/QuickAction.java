...
package com.naijamojiapp.app.quickactiondialog;
...
import static com.naijamojiapp.app.quickactiondialog.ArrowDrawable.ARROW_DOWN;
import static com.naijamojiapp.app.quickactiondialog.ArrowDrawable.ARROW_UP;
...
public class QuickAction extends PopupWindows implements OnDismissListener {
    ...
    public QuickAction(@NonNull Context context, int orientation) {
        ...
        stroke = resource.getDimensionPixelSize(R.dimen.margin_1dp);
    ...
    public void setColor(@ColorInt int popupColor) {
        ...
        drawable.setCornerRadius(resource.getDimension(R.dimen.margin_7dp));
    ...
    private void addActionView(int position, View actionView) {
        if (orientation == HORIZONTAL && position != 0) {
            ...
            int width = resource.getDimensionPixelOffset(R.dimen.margin_1dp);
